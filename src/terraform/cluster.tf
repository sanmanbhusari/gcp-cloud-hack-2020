module "network" {
  source = "C:/Users/sanma/source/repos/terraform-gcp-vpc-native/default"
...
module "cluster" {
  source                           = "C:/Users/sanma/source/repos/terraform-gke/vpc-native"
  region                           = "us-central1"
  name                             = "gke-example"
...
module "node_pool" {
  source             = "C:/Users/sanma/source/repos/terraform-gke//node_pool?ref=node-pool-v3.0.0"
